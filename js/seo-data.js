(function (root, factory) {
  ...
  const PAGE_META = {
    ...
    aktualis: {
      ...
      image: BASE_URL + "/img/astangasmr26.webp",
      priority: "0.9",
      changefreq: "weekly",
    },
    orak: {
      title: "Jógaórák | Czvikli Zsuzsanna",
      description: "Flow jóga Budapesten és online. Csoportos jógaórák, Astanga + SMR online sorozat. Samadhi Jóga Stúdió, Budapest XIII. ker.",
            ...
            itemListElement: [
              {
                ...
                name: "Astanga + SMR - kezdő/újrakezdő online gyakorlás",
              },
              {
                "@type": "ListItem",
                position: 2,
